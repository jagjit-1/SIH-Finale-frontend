...
const LoggedIn = () => {
    ...
    return (
        <Drawer.Navigator initialRouteName="Attendance" screenOptions={{ drawerType: 'back', drawerLabelStyle: { marginLeft: -17 }, drawerStyle: { width: 320, borderWidth: 3, borderColor: '#673AB7' } }} drawerContent={props => <CustomDrawer {...props} />}>
            <Drawer.Screen name="Attendance" component={LandingScreen} options={{ drawerIcon: () => (<Octicons name="dot-fill" size={20} color="#3700B3" />) }} />
